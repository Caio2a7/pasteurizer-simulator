...
<template>
    <div class="xl:w-full xl:max-w-5xl lg:min-w-130 sm:min-w-100 mx-0 flex flex-col overflow-hidden rounded-2xl border border-gray-300 bg-white shadow-lg hover:shadow-2xl transition-shadow duration-300">
